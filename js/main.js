...
// Document Elements
var image = document.getElementById("MealImg");
var ingredients = document.getElementById("MealIngredients");
var instructions = document.getElementById("MealInstructions");
var tips = document.getElementById("MealTips");

// Getting a random index from the main array
var RandIdx = Math.floor(Math.random() * MealsData.length);
var PageIdx = MealsData[RandIdx];

// Page Loading Function
function MealOnLoading(meal) {
  // Adding Main Image
  image.querySelector("img").src = meal.img;

  // Adding Meal Info Data
  document.getElementById("MealRating").innerHTML = meal.rating;
  document.getElementById("MealReviews").innerHTML = meal.reviews;
  document.getElementById("PrepTime").innerHTML = meal.PrepTime;
  document.getElementById("CookTime").innerHTML = meal.CookTime;
  document.getElementById("serving").innerHTML = meal.serving;
  document.getElementById("MealDifficulty").innerHTML = meal.difficulty;
  document.getElementById("MealCountry").innerHTML = meal.country;
  document.getElementById("MealName").innerHTML = meal.name;
  document.getElementById("MealDesc").innerHTML = meal.desc;

  // Adding Meal Nutrition Data
  document.getElementById("calories").innerHTML = meal.nutrition.calories;
  document.getElementById("carbs").innerHTML = meal.nutrition.carb;
  document.getElementById("fibers").innerHTML = meal.nutrition.fiber;
  document.getElementById("protein").innerHTML = meal.nutrition.protein;
  document.getElementById("fats").innerHTML = meal.nutrition.fat;
  ...
  for (var i = 0; i < meal.ingredients.length; i++) {
    ingredients.innerHTML += `<div class="d-flex mb-1">
                                    <div class="number-wrapper px-2 me-3 rounded-circle text-white text-center">
                                        ${i + 1}
                                    </div>
  ...
  // Instructions
  for (var j = 0; j < meal.instructions.length; j++) {
    instructions.innerHTML += `<div class="d-flex align-items-baseline mb-3">
                                    <div class="number-wrapper py-2 px-3 me-3 rounded-4 text-white text-center">
                                        ${j + 1}
                                    </div>
                                    <p>${meal.instructions[j]}</p>
                                </div>`;
  }

  // Tips
  for (var z = 0; z < meal.tips.length; z++) {
    tips.innerHTML += `<div class="tip d-flex align-items-baseline pt-4 mb-3 pb-2 px-3 rounded-4">
...
// Display On Loading
image.innerHTML += `<img src="${MealsData[RandIdx].img}" alt="#" class="main-img w-100 h-100 object-fit-cover">`;
MealOnLoading(PageIdx);

// Button Function
function TryAnother() {
  var FunRandIdx = Math.floor(Math.random() * MealsData.length);
  var BtnIdx = MealsData[FunRandIdx];
  MealOnLoading(BtnIdx);
}
